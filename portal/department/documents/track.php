  ...
  <div class="container-fluid">
          ...
          <div class="row height d-flex justify-content-center align-items-center">
              <div class="search">
                  <form action="track.php" method="get">
                      <input type="text" class="form-control" name="reference" value="<?= $_GET['reference'] ?? null; ?>" placeholder="Enter document reference number">
      ...
      <?php if (isset($_GET['reference'])) {
            ...
            if ($document = $Document->OneByDepartment($code, $_GET['reference'])) {
                              ...
                              <div id="tracking">
                                  ...
                                  <div class="tracking-list">
                                      ...
                                      <?php
                                        ...
                                        ?>
                                          <div class="tracking-item">
                                              <div class="tracking-icon status-intransit  <?= $has_warning_document_time . ' ' . $status_class  ?>">
                                                  <!-- <img src="../../../assets/images/logos/favicon.png" alt="" width="30"> -->
                                              ...
                                              <div class="tracking-content">
                                                  <?= $Department->Info($row['department'], 'code')['department']; ?><span><?= $time ?></span>
                                                  <?php if ($row['status'] == 'Done') {  ?>
                                                      <button class="btn btn-primary btn-sm mt-1" onclick="remarks('<?= $row['note'] ?>', '<?= $row['department'] ?>')">Remarks</button>
                                                  <?php  } ?>
                                              </div>
                                          </div>

...
$doneCount = 0;
$ongoingCount = 0;
foreach ($Document->DepartmentDocument($code) as $row) {
  if ($row['status'] === 'Done') {
    $doneCount++;
  } else {
    $ongoingCount++;
            ...
            <div class="card w-100">
                <div class="card-body p-4">
                    ...
                    <div class="table-responsive">
                        <table class="table text-nowrap mb-0 align-middle" id="">
                                ...
                                <tr>
                                    ...
                                    <td class="border-bottom-0">
                                        <div class="d-flex align-items-center gap-2">
                                            <span
                                                class="badge bg-primary rounded-3 fw-semibold"><?= $row['status'] ?></span>
                                        </div>
                                    </td>
                                </tr>
                                <?php   } ?>
